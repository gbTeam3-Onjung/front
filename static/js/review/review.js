...
for (let i = 0; i < 10; i++) {
    ...
    cardDivider.classList.add("review-card-divider", "review-rectangle-card");
                ...
                <div class="card-image-container">
                    <div class="card-image-default card-image">
                        <div>
                            ...
                            <img src="https://cdn-dantats.stunning.kr/prod/portfolios/37db3714-d292-481e-a288-d29b7c2a6279/covers/eavxYqGTx3xsnczv.%EC%88%A8_1.%EC%84%AC%EB%84%A4%EC%9D%BC.jpg.small?s=1000x1000&amp;e=195x249&amp;t=crop&amp;q=100&amp;f=webp" alt="삼성숨정신건강의학과의원의 삼성숨정신건강의학과의원 이미지" />
                        </div>
                    </div>
                </div>
            </a>
                    ...
                    <div class="review-user-info">
                        <div class="review-score">
                            <div class="review-rate-star">
                                <svg class="gKXOVf dryTGB stunning-star active" viewBox="0 0 32 32">
                        ...
                        <div class="review-user">
                            <span class="review-user-nick"><a href="/m/jk8171822" class="review-user-nick-inner">삼성숨정신건강의학과의원</a></span>
                ...
                <div class="review-comment-container">
                    <div class="review-comment-area">
                        <div class="review-comment">
                            콘테스트를 통해 디자이너 분들의 좋은 디자인을 많이 접할 수 있어서 만족스러웠고, 친절히 설명해주시고 요청 사항에 빠른 피드백을 주셔서 비대면임에도 진행과정이 편리했습니다. 참여해주신 모든 분들께 정말 감사드리고, 앞으로도 자주 이용하겠습니다.
                        </div>
                    </div>
                </div>
                <div class="review-type-wrap">
                    <div class="review-type-container">
                        <div class="review-type-product">
                            <span class="product-type">구매등급 : 일반형</span>
                            <span class="contest-participation">59명 참여</span>
                        </div>
                    </div>
                </div>
            </div>
